...
main_menu() {
    while true; do
        ...
        echo "────────────────────────────────────────"
        echo ""
        echo "  ${CYAN} 1)${NC} ⚙  Setup inicial (configurar tudo)"
        echo "  ${CYAN} 2)${NC} 🚀 Build & Deploy"
        echo "  ${CYAN} 3)${NC} ⏹  Parar containers"
        echo "  ${CYAN} 4)${NC} 🔄 Reiniciar containers"
        echo "  ${CYAN} 5)${NC} 📋 Ver logs"
        echo "  ${CYAN} 6)${NC} 📦 Rodar migrations"
        echo "  ${CYAN} 7)${NC} 🌱 Rodar seeds"
        echo "  ${CYAN} 8)${NC} 🔑 Regenerar JWT keys"
        echo "  ${CYAN} 9)${NC} 📊 Status dos serviços"
        echo "  ${CYAN}10)${NC} 💾 Backup do banco"
        echo "  ${CYAN}11)${NC} 📥 Restaurar backup"
        echo "  ${CYAN}12)${NC} 🔨 Rebuild (API/Frontend)"
        echo "  ${CYAN}13)${NC} 🧹 Cleanup tokens expirados"
        echo ""
        echo "  ${CYAN} 0)${NC} 🚪 Sair"
        echo ""
        echo "────────────────────────────────────────"
